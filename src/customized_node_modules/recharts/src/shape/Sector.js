...
const getSectorPath = ({ cx, cy, innerRadius, outerRadius, startAngle, endAngle, endRadius }) => {
  ...
  if (innerRadius > 0) {
    ...
    const endShape = endRadius ?
      `A ${endRadius}, ${endRadius}, 0, 0, 1, ${innerEndPoint.x},${innerEndPoint.y}` :
...
class Sector extends Component {
  ...
  render() {
    const { cx, cy, innerRadius, outerRadius, startAngle, endAngle, className, endRadius} = this.props;
    ...
    return (
      <path
        ...
        d={getSectorPath({ cx, cy, innerRadius, outerRadius, startAngle, endAngle, endRadius })}
      />
    );
  }
}
