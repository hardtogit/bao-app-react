...
class Picker extends React.Component {
    ...
    render () {
        ...
        return (
            <div className={styles.ui_picker_wrapper} onTouchStart={this.handleWrapperStart.bind(this)}>
                <div className={styles.ui_picker}
                ...
                <div className={styles.ui_picker_center}></div>
            </div>
        )
    }
}
