...
import{GatherDetail,GatherDeposits,GatherProblems,GatherJoin,GatherBuy,GatherBidDetail,GatherBorrowDetail,
    ...
    WisdomMy,WisdomRecord,WisdomMyDetail,WisdomMyMain,EmptyTemplate,FillList,FillDetail
        ...
        return (
         ...
         <Router history={history}>
          <Route path="/" component={PageTransition}>
              ...
              <Route path="fillList/:id/:type" getComponent={FillList}></Route>
              <Route path="fillDetail/:id" getComponent={FillDetail}></Route>
              ...
              <Route path="user" getComponent={User} >
                  ...
                  <Route path="moneyLogMain" getComponent={MoneyLogMain} onEnter={(nextState,replace)=>{Auth.isLogined(store,nextState,replace)}}></Route>/*余额明细*/
