    ...
    render(){
        return(<div className={styles.bg}>
            ...
            <div className={styles.content}>
                <p>宝点网（bao.cn）合同编号：</p>
                <h1 className={styles.title}>定存宝投资咨询及管理服务协议</h1>
                <div className={styles.text}>
                    尊敬的投资客户：为了维护您的自身权益、防范投资风险，请在投资前仔细阅读本协议各条款（尤其是风险提示）、以及与本产品相关的全部产品规则，特别是加粗字体条款，以充分知悉、
                    了解宝点网零钱宝产品的运作规则、投资范围以及协议双方的权利、义务和责任。一旦加入本投资计划即视为对本协议全部条款及相关业务规则已充分理解并完全接受。
                </div>
                <div className={styles.text}>
                    在乙方充分了解并清楚知晓本产品投资风险的前提下,本《定存宝投资协议》（以下简称“本协议”）由以下双方于 2015年08月19日签订：
                </div>
                <div className={styles.text}>
                ...
                <div className={styles.text}>
                    甲乙双方经友好协商，本着平等自愿、诚实信用的原则，就提供的“定存宝”投资计划的相关事项订立有效合约，达成如下协议：
                </div>
                <div className={styles.text}>
                    <p>释义：</p>
                ...
                <div className={styles.text}>
                    1.1 定存宝：定存宝是宝点网推出的对经合作机构全额本息担保的借款项目进行自动优先投资及投资期限届满时自动转让债权的投资计划，可通过系统实现自动化的分散投资。
                    定存宝现阶段分为3个月、6个月及12个月三种期限模式，乙方出借的本金和收益将在投资期限届满后一次性返回其宝点网账户。
                </div>
                <div className={styles.text}>
                ...
                <div className={styles.text}>
                    1.4 投资金额及预期收益：乙方知悉、了解并同意，本协议项下涉及的任何收益均为预期收益，甲方未以任何方式对本金及预期收益进行承诺或担保，
                ...
                <div className={styles.text}>
                    2.1 本协议成立：乙方按照宝点网的规则，通过在宝点网上勾选“我同意《宝点网定存宝投资协议》”以及点击“加入”按钮
                ...
                <div className={styles.text}>
                    2.3.1 本期定存宝所对应的加入资金全部冻结，且甲方系统完成所有资金的自动投资后，根据本期定存宝所投特定项目的《宝点网借款合同》的相关约定，乙方及上述特定项目的借款客户即不可撤销地授权甲方委托相应的第三方支付机构及/或监管银行等合作机构，将金额等同于本协议1.4条所列的“期初加入本金数额”的资金，
                ...
                <div className={styles.text}>
                    3.1 乙方全权委托甲方按照本协议的约定，对等同于本协议1.4条所列的“期初加入本金”进行自动优先投资，作为出借资金出借给宝点网平台上经甲方及合作机构推荐、
                    并且得到合作机构全额本息担保的借款客户；同时，乙方授权甲方在完成上述自动优先投资后以乙方名义代为签署相应的《宝点网借款合同》。
                </div>
                <div className={styles.text}>
                    3.2 投资范围：宝点网平台上的经甲方及合作机构推荐、并且得到合作机构全额本息担保的借款项目。
                </div>
                <div className={styles.text}>
                    3.3 乙方加入定存宝后，甲方将按照乙方加入本期定存宝的时间的先后顺序，
                    对加入资金进行自动优先投资。先加入定存宝的资金，在同期定存宝所对应的全部资金内具有自动优先投资和到期赎回的更高优先级。
                </div>
                <div className={styles.text}>
                    3.4 后续管理：在本期定存宝的存续期限内，乙方全权委托甲方对本期定存宝所投资项目的后续回款进行如下处理并以乙方名义代为签署相应的《宝点网借款合同》：
                </div>
                <div className={styles.text}>
                    3.4.1 甲方将把本期定存宝所投资项目返还的本金（包括但不限于借款项目当期还款所还本金、提前还款所还本金等）自动优先投资到新的项目中，投资范围参见本协议第3.2条。
                </div>
                <div className={styles.text}>
                    3.4.2 对于定存宝所投资项目产生的收益，甲方将根据第4.3条约定进行收益复投，投资范围参见本协议第3.2条。
                </div>
                <div className={styles.text}>
                ...
                <div className={styles.text}>
                    ...
                    将显示在乙方宝点网账户中；未成功转让的债权将自动退出本投资计划，并以借款项目的形式显示在乙方宝点网账户中，
                    乙方将按该借款项目的还款方式及剩余还款期限，获得相应的本金及/或利息回款直至该借款项目完成全部还款；同时，甲方向乙方退还其在本期定存宝中已实际收取的所有管理费用。
                </div>
                <div className={styles.text}>
                    3.8 逾期项目：若甲方按本协议约定为乙方投资的借款项目，在乙方持有该借款项目期间出现逾期还款且合作机构未立即履行担保义务的情况，则此借款项目将自动退出本投资计划，
                ...
                <div className={styles.text}>
                    4.1 收益来源：乙方委托甲方通过自动优先投资将资金出借给宝点网平台上的借款客户后，借款本金所产生的利息或借款本息复投所产生的利息在扣除管理费用剩余部分作为定存宝收益支付给乙方。
                </div>
                <div className={styles.text}>
                    4.2 收益起算时间：自本协议生效日开始计算收益。
                </div>
                <div className={styles.text}>
                    4.3 收益分配方式：收益复投、到期分配的方式，即在本期定存宝存续期限内，乙方加入本期定存宝后产生的收益将按照自动优先投资的原则进行投资，投资范围参见本协议第3.2条。
                </div>
                <div className={styles.text}>
                ...
                <div className={styles.text}>
                    5.3 乙方同意甲方有权根据国家法律法规、监管政策、自律规定、市场变化等对本协议及与本协议相关的规则进行调整，甚至终止本投资计划。
                </div>
                <div className={styles.text}>
                    5.4 调整或修改后的协议内容及相关业务规则将在宝点网（包括但不限于官网公告、站内信、手机平台等方式）进行公布并立即生效，无需另行通知乙方。如果乙方不接受修改，
                    可立即以赎回本投资计划中全部加入资金的方式终止本服务；如乙方继续使用本投资计划的即被视为接受修改，并受修改后的协议及相关业务规则约束。
                </div>
                <div className={styles.text}>
                    5.5 乙方同意，在甲方终止本协议的提供时，乙方持有的本投资计划项下的借款项目将以借款项目的形式显示在乙方宝点网账户中，
