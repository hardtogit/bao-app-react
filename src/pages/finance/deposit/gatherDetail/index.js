               ...
               <div className={styles.container}>
                   ...
                   <div className={styles.introduce}>
                       ...
                       <p className={styles.content}>
                           “聚点+”是宝点网推出的新型智能出借服务工具。加入聚点+的资金将由系统在出借者认可的标的范围内分散匹配符合要求的标的，持续服务期间内系统在出借者授权下将所投标的回款自动再次匹配符合要求的标的，并在计划到期后自动转让退出。参考回报不代表对实际利息回报的承诺。
                       </p>
                   </div>
                   </div>
                   <div className={styles.items}>
                       ...
                       <Item name="退出规则" value="聚点+对应期限到期后用户自发申请债权转让，若到期24小时内未自己申请，将由系统申请进行债权转让"></Item>
