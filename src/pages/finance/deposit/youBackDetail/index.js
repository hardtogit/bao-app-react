...
const mapStateToProps=(state)=>{
    return{
        listData:state.listdata.getIn(['YOU_BID_BACK_DETAIL','data']),
        pending:state.listdata.getIn(['YOU_BID_BACK_DETAIL','pending']),
        end:state.listdata.getIn(['YOU_BID_BACK_DETAIL','pageEnd'])
    }
}
