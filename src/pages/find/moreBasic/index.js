...
class moreBasic extends Component{
    constructor(props){
        super(props)
    }
    componentDidMount(){
    ...
    render(){
       ...
       if (noticeData){
        ...
        return(
             ...
             <div className={styles.findMessageHeader}><NavBar title="商城首页" onLeft={pop}/>
             </div>
...
export default connect(initMymassege,initMymassegefn)(moreBasic)