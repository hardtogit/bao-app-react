           ...
           <div className={styles.container}>
              <NavBar onLeft={()=>{pop('gatherBuy/3/2')}}>
               ...
               <div className={styles.content}>
                   ...
                   <div className={styles.text}>
                       因国家相关法律、法规、部门规章或政策发生重大调整、变化或其他不可预知的意外事件，导致出借人无法实现参考回报乃至本金遭受损失。
                   </div>
                   <div className={styles.sign}>
                       2.市场风险
                   </div>
                   ...
                   <div className={styles.text}>
                       无论何种原因，当债务人短期或者长期丧失还款能力，不能按时偿还本金和利息，导致出借人无法实现参考回报，甚至本金遭受损失。宝点网作为信息中介平台，不承诺本息保障。
                   </div>
                   <div className={styles.sign}>
                       4.技术风险
                   </div>
                   ...
                   <div className={styles.text}>
                       根据政策及市场环境变化，宝点理财有权停止系统实时匹配交易功能、停止提供账户服务、技术服务及其他相关服务，在提前终止情形下，出借人面临丧失出借机会及再出借的风险，并导致出借人无法实现参考回报。
                   </div>
                   <div className={styles.sign}>
                       6.信息风险
                   </div>
