              ...
              <NavBar onLeft={()=>{pop('gatherBuy/3/2')}}>
               ...
               <div className={styles.content}>
                   ...
                   <div className={styles.text}>
                       ...
                       您承诺已完全理解并知悉本提示函及相关文件的全部内容，已具备出借风险意识、风险识别能力、拥有非保本类金融产品出借的经历并熟悉互联网，
                       同时保证已充分了解本提示函基本情况及风险特征，确认具有相应的风险认知和承受能力；且愿意自行承担可能产生的本金或收益损失。
                   </div>
                   <div className={styles.text}>
                       根据网络借贷相关法律法规及监管要求，请您在出借之前，仔细阅读以下重要内容:
                   </div>
                   <div className={styles.text}>
                       当您点击“抢购”、“立即出借”、“确认出借”、“马上买入”、”确认”、”再次购买”或其他类似涵义选项时，即视为您已经阅读并完全理解、认同并接受以下关于出借标的的各种风险，并为自身的出借决策自行承担全部风险。
                   </div>
                   <div className={styles.sign}>
                       1.政策风险
                   </div>
                   <div className={styles.text}>
                       因国家相关法律、法规、部门规章或政策发生重大调整、变化或其他不可预知的意外事件，导致出借人无法实现预期收益乃至本金遭受损失。
                   </div>
                   <div className={styles.sign}>
                       2.市场风险
                   </div>
                   ...
                   <div className={styles.text}>
                       无论何种原因，当债务人短期或者长期丧失还款能力，不能按时偿还本金和利息，导致出借人无法实现预期收益，甚至本金遭受损失。宝点网作为信息中介平台，不承诺本息保障。
                   </div>
                   <div className={styles.sign}>
                       4.技术风险
                   </div>
                   ...
                   <div className={styles.text}>
                       根据政策及市场环境变化，宝点理财有权停止系统实时匹配交易功能、停止提供账户服务、技术服务及其他相关服务，在提前终止情形下，出借人面临丧失出借机会及再出借的风险，并导致出借人无法实现预期收益。
                   </div>
                   <div className={styles.sign}>
                       6.信息风险
                   </div>
                   ...
                   <div className={styles.text}>
                       宝点理财将按协议约定进行信息披露，出借人应充分关注并及时主动查询项目相关信息，如未及时查询，或由于通讯故障、系统故障以及其他不可抗力等因素的影响使得无法及时了解项目信息，由此产生责任和风险应由出借人承担。
                   </div>
                   <div className={styles.sign}>
                       8.不可抗力风险
                   </div>
