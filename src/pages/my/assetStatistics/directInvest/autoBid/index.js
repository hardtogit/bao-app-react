        ...
        return (
            <div>
                    ...
                    <div className={classnames(style.content)}>
                        <ul className={style.times}>
                            <li>
                                ...
                                <input type="text" ref="countInput" value={this.state.count} onChange={(e) => {
                                    this.countBlur(e)
                                }} placeholder="最多可设置99次" maxLength="2"/>
                                <span className={style.desc}>次</span>
                            </li>
                            <li>
                                <span className={style.title}>单次投标份数</span>
                                <input type="number" ref="timesInput" value={this.state.balance} onChange={(e) => {
                                    this.timesBlur(e)
                                }}/>
                ...
                <DurationSelect ref="durationSelect" from={this.state.start} to={this.state.end}
                                callBackFun={this.durationChoose} items={
                    [1, 3, 6, 12, 24]
                }/>
