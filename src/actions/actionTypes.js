...
export const GET_VIP_STR='GET_VIP_STR' //用户VIP信息
export const GET_RATE_COUPONS='GET_RATE_COUPONS' //加息券列表
export const GET_RATE_INFO='GET_RATE_INFO' //加息券领取情况
export const GET_VOUCHER_COUPONS='GET_VOUCHER_COUPONS' //抵用券列表
export const GET_VOUCHER_INFO='GET_VOUCHER_INFO' //抵用券领取情况
export const GET_GOODS_LIST='GET_GOODS_LIST' //商品列表
export const GET_GOODS_LIST_NEW='GET_GOODS_LIST_NEW' //抵用券列表
export const GET_GOODS_LIST_NEW_ONE='GET_GOODS_LIST_NEW_ONE' //抵用券列表
export const GET_GOODS_LIST_NEW_TWO='GET_GOODS_LIST_NEW_TWO' //抵用券列表
...
export const CANCEL_CASH_GOODS='CANCEL_CASH_GOODS' //兑换取消
...
//验证更换手机号是否成功
export const VERIFY_BIND_MOBILE='VERIFY_BIND_MOBILE'
...
//存管修改绑定手机号发送验证吗
export const STORE_SEND_CODE_CHANGE='STORE_SEND_CODE_CHANGE'
//验证该验证码是否发送成功
export const CHANGE_CODE_VERIFY='CHANGE_CODE_VERIFY'
//验证该验证码是否正确
export const CHANGE_CODE_RIGHT_VERIFY='CHANGE_CODE_RIGHT_VERIFY'
//验证验证码
export const STORE_VERIFY_CODE='STORE_VERIFY_CODE'
//修改绑定手机验证码
export const STORE_CHANGE_PHONE_VERIFY_CODE='STORE_CHANGE_PHONE_VERIFY_CODE'
//绑定银行卡
...
export const STORE_BIND_MOBILE_MODIFY = 'STORE_BIND_MOBILE_MODIFY'
...
export const STORE_TRADE_PASSWORD_MODIFY = 'STORE_TRADE_PASSWORD_MODIFY'//存管交易密码修改
export const TRADE_PASSWORD_SET = 'TRADE_PASSWORD_SET'
export const NEW_TRADE_PASSWORD_SET='NEW_TRADE_PASSWORD_SET'
...
export const  NEW_TRANSACTION_CODE='NEW_TRANSACTION_CODE'
export const  LOGIN_OUT='LOGIN_OUT'
export  const CLAER_USER='CLAER_USER'
export const CHECK_VERIFY_CAPTCHA_W='CHECK_VERIFY_CAPTCHA_W'
export const NEW_CHECK_VERIFY_CAPTCHA_W='NEW_CHECK_VERIFY_CAPTCHA_W'
...
export const DEEP_CLEAR_INFO_DATA='DEEP_CLEAR_INFO_DATA' //彻底清除info数据
...
export const CHOICE_CARD='CHOICE_CARD'//提现选择银行卡
export const WITHDRAW='WITHDRAW' //提现
export const SERVICE_CHARGE_RULE='SERVICE_CHARGE_RULE'//获取提现手续费规则
export const IDCARD_UPLOAD='IDCARD_UPLOAD'//身份证上传
...
export const DEPOSITS_GATHER_INDEX='DEPOSITS_GATHER_INDEX'//聚点首页
...
export const GATHER_QUIT='GATHER_QUIT'//聚点+退出
...
export const DEPOSITS_YOU='DEPOSITS_YOU' //优享列表
export const DEPOSITS_YOU_INDEX='DEPOSITS_YOU_INDEX'//优享首页
export const YOU_DETAIL='YOU_DETAIL' //优享+详情
export const YOU_PROBLEMS='YOU_PROBLEMS' //优享+问题
export const YOU_BID_LIST='YOU_BID_LIST' //优享+标
export const YOU_JOIN='YOU_JOIN'//加入记录\
export const YOU_QUIT='YOU_QUIT'//优享+退出
export const YOU_BID_DETAIL='YOU_BID_DETAIL'//标的借款详情
export const YOU_BID_BACK_DETAIL='YOU_BID_BACK_DETAIL'//标的还款详情
export const YOU_INVEST_RECORD='YOU_INVEST_RECORD'//投资记录
export const YOU_PROJECTS='YOU_PROJECTS'//优享+项目列表
export const YOU_MY_LIST_ONE='YOU_MY_LIST_ONE'//我的优享+列表(持有中)
export const YOU_MY_LIST_TWO='YOU_MY_LIST_TWO'//我的优享+列表(退出中)
export const YOU_MY_LIST_THREE='YOU_MY_LIST_THREE'//我的优享+列表(已退出)
export const YOU_MY_HEADER='YOU_MY_HEADER'//我的优享头
export const YOU_BUY='YOU_BUY'//优享购买
// export const GATHER_CONTRACT='GATHER_CONTRACT' //优享合同
// export const GATHER_SERVER_CONTRACT='GATHER_SERVER_CONTRACT'//优享服务协议
//聚点债转
...
export const SAVE_YOU_DATA='SAVE_YOU_DATA'//存储优享+数据
...
export const GET_FILL_CONTRACTS_LIST='GET_FILL_CONTRACTS_LIST'//获取购买合同列表
export const GET_DETAIL_BY_PRODUCT_ID='GET_DETAIL_BY_PRODUCT_ID'//根据产品ID获取详情
export const GET_DETAIL_BY_CONTRACT_ID='GET_DETAIL_BY_CONTRACT_ID'//根据合同Id获取详情
export const GET_PRODUCT_DISPLAY='GET_PRODUCT_DISPLAY'//获取产品显示状态
export const GET_YOU_DETAIL='GET_YOU_DETAIL'//获取优享详情